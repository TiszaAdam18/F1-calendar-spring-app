...
-- Először le kell kérdezni a csapat ID-kat, vagy fix ID-kat használni, ha tudjuk őket.
-- Itt feltételezzük, hogy az ID-k 1, 2, 3, stb. sorrendben generálódnak.
...
-- Hasonlóan, a circuit_id-k is feltételezett ID-k.
